...
public class RemoteItinerary {
    ...
    private RemoteItinerary(ItineraryBuilder builder) {
    ...
    public static class ItineraryBuilder {
        ...
        public RemoteItinerary build() {
            return new RemoteItinerary(this);
        }
    }
}
